...
// Add to the schema — conditional on isNew
...
// Add isNew prop to TherapistForm
interface Props {
  therapist?: Therapist;
  onSubmit: (
...
export default function TherapistForm({
  ...
  return (
    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-5">
      ...
      {/* Email + password — only shown when creating a new therapist */}
      {!therapist && (
        <>
          <div className="space-y-1.5">
            ...
            <p className="text-xs text-muted-foreground">
              The therapist will use this email to log in.
            </p>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-xs text-muted-foreground">
              Share this with the therapist. They can change it after logging
              in.
            </p>
          </div>
        </>
